            ...
            <div className="flex flex-col md:flex-row items-center gap-6 sm:gap-8 md:gap-12">
                <div className="md:flex-1 md:order-2">
                    ...
                    <p className="text-[#96c5a9] text-base sm:text-lg leading-relaxed mb-6">
                        ...
                        Explore my complete portfolio to discover the full range of software engineering and full stack projects I&apos;ve worked on.
                    </p>
                    <motion.a href="https://prestilienpindoh.web.app" target="_blank" rel="noopener noreferrer"
