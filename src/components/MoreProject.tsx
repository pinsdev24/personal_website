  ...
  return (
    <section id="projects">
        <div className="flex flex-col md:flex-row items-center gap-6 sm:gap-8 md:gap-12">
            ...
            <a href="https://portfolio.prestilienpindoh.me" target="_blank" rel="noopener noreferrer" 
                className="inline-flex items-center justify-center rounded-full h-12 px-8 bg-[#38e07b] text-[#122118] text-lg font-bold leading-normal tracking-[0.015em] hover:bg-opacity-90 transition-colors">
                <span className="truncate">View my portfolio</span>
            </a>
            </div>
            <div className="md:flex-1 md:order-1">
            <div className="relative overflow-hidden rounded-lg sm:rounded-xl shadow-lg aspect-video">
