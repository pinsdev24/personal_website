...
export default function Hero() {
  return (
    <section className="group relative min-h-[400px] sm:min-h-[450px] md:min-h-[520px] rounded-xl sm:rounded-2xl overflow-hidden flex items-end p-6 sm:p-8 md:p-12">
      <div
      ...
      <div className="flex flex-col md:flex-row items-center md:items-start gap-6 sm:gap-8 md:gap-10">
        <div className="flex flex-col gap-4 sm:gap-6 text-left max-w-3xl flex-1">
          <h1 className="text-white text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold leading-tight tracking-tighter drop-shadow-[0_2px_14px_rgba(56,224,123,0.15)]">
